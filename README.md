...
```
* **install in your user**: after compile it you need to move it to /usr/local/bin/ by doing
```bash
sudo mv wallpaper /usr/local/bin/
```
* **general system installation** after compile it you need to move it to /bin by doing
```bash
